...
export const InfoIcon: React.FC<{ size?: number }> = ({ size = 24 }) => (
...
export const BellIcon: React.FC<{ size?: number }> = ({ size = 24 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
...
export const VolumeIcon: React.FC<{ size?: number }> = ({ size = 24 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
...
export const Top10Badge: React.FC = () => (
  <div className="netflix-top10-badge">TOP 10</div>
);
